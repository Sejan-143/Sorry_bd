...
\033[1;92m ╚══════╝╚══════╝ ╚════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝
 ...
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mপিৃ্ঁনিৃ্ঁকৃ্ঁ卝Sʜʌwoŋ\033[1;92m   |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/sejanrahmans?mibextid=ZbWKwL')
       main()  
...
def m(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            "user-agent": pro}
            lo = requests.get('https://mbasic.facebook.com/', cookies=cookies,headers=header).text
